...
function paginatedMeta(total, limit = 20) {
    return {
        page: 1,
        limit,
        total,
...
function paginated(data, limit = 20) {
    ...
    auth: {
        ...
        loginResponse: {
            ...
            user: {
                ...
                role: role_dto_1.RoleName.ADMIN,
            },
        },
        meResponse: {
            uid: 1,
    ...
    users: {
        create: {
            ...
            value: {
                ...
                role: role_dto_1.RoleName.AUDITOR,
            },
        },
        update: {
            summary: "Update user",
        ...
        paginated: paginated([
            ...
            },
            {
                ...
                role: role_dto_1.RoleName.MANAGER,
                isActive: true,
                createdAt: TS,
            },
            {
    ...
    engagements: {
        create: {
            ...
            value: {
                ...
                endDate: "2025-06-30",
                status: engagement_dto_1.EngagementStatus.IN_PROGRESS,
    ...
    issues: {
        create: {
            ...
            value: {
                ...
                severity: enums_dto_1.Priority.HIGH,
        ...
        update: {
            ...
            value: {
                id: 1,
                status: enums_dto_1.IssueStatus.IN_PROGRESS,
                severity: enums_dto_1.Priority.HIGH,
            },
        },
            ...
            statusLogs: [
                {
                    ...
                    newStatus: enums_dto_1.IssueStatus.IN_PROGRESS,
        ...
        paginated: paginated([
            ...
            },
            {
                ...
                severity: enums_dto_1.Priority.MEDIUM,
                status: enums_dto_1.IssueStatus.OPEN,
    ...
    tasks: {
        create: {
            ...
            value: {
                ...
                status: enums_dto_1.TaskStatus.PENDING,
            },
        },
        update: {
            summary: "Update task",
            value: { id: 1, status: enums_dto_1.TaskStatus.IN_PROGRESS },
        },
        assign: { summary: "Assign to auditor", value: { assignedToId: 3 } },
        comment: {
            summary: "Add comment",
        ...
        listItem: {
            ...
            title: "Perform revenue substantive testing",
            description: "Sample 25 invoices across Q3 and Q4",
            status: enums_dto_1.TaskStatus.IN_PROGRESS,
            assigneeName: "Auditor",
            createdAt: TS,
        },
        detail: {
    ...
    risks: {
        create: {
            ...
            value: {
                ...
                priority: enums_dto_1.Priority.HIGH,
                status: enums_dto_1.RiskStatus.OPEN,
            },
        },
        update: {
            summary: "Update risk",
            value: { id: 1, status: enums_dto_1.RiskStatus.OPEN, priority: enums_dto_1.Priority.HIGH },
        },
        checklistCreate: {
            summary: "Add checklist item",
        ...
        riskReport: {
            ...
            items: [
                ...
                },
                {
                    ...
                    priority: enums_dto_1.Priority.MEDIUM,
                    status: enums_dto_1.RiskStatus.OPEN,
...
//# sourceMappingURL=api-examples.js.map