...
class UserListItemDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { uid: { required: true, type: () => Number }, name: { required: true, type: () => String }, email: { required: true, type: () => String }, role: { required: true, enum: require("../common/role.dto").RoleName }, isActive: { required: true, type: () => Boolean }, createdAt: { required: true, type: () => Date } };
    }
}
...
], UserListItemDto.prototype, "uid", void 0);
__decorate([
